...
<main>
    <div class="container" style="margin-top: 100px">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                <h1>404</h1>
                <h2><?= translate("UH OH! You're lost.") ?></h2>
                <p><?= translate("The page you are looking for does not exist.") ?>
                    <?= translate("How you got here is a mystery. But you can click the button below") ?>
                    <?= translate("to go back to the homepage.") ?>
                </p>
                <a href="<?= $url->application("dashboard")->page("dashboard")->output() ?>" class="btn green">HOME</a>
            </div>
        </div>
    </div>
</main>
