...
if (not_empty(get_request("method"))) {
    $method_updated = $domains->updateValidationMethod(get_request("method"), $url->getId());
                        ...
                        <div class="tab-content p-3">
                            ...
                            <?php } elseif ("dns" === $domains->getValidationMethod()) { ?>
                                ...
                                <div class="dns-step-block">
                                    ...
                                    <div class="fields-view">
                                        ...
                                        <span class="dns-fields" data-label="<?= translate("TTL:") ?>">14400</span>
                                    </div>
                                </div>
                                <div class="dns-step-block">
                            ...
                            <?php } elseif ("html" === $domains->getValidationMethod()) { ?>
                                <div class="dns-step-block">
                                    ...
                                    <span class="dns-line mt-2 d-flex justify-content-center"><a href="<?=$url->application("owned-domain")->page($domains->getPublicKey())->output()?>"  target="_blank"
                                ...
                                <div class="dns-step-block">
                                    ...
                                    <span class="dns-line mt-2 d-flex justify-content-center"><a href="<?="https://" . $domains->getDomain() . "/" . $domains->getVerificationKey() . ".html"?>"
                                                                                                 class="btn mb-1 btn-wave" target="_blank"><?= translate("Access destination path") ?></a></span>
                                </div>
                            <?php } ?>
                            ...
                            <div class="row py-3">
                                <div class="col-12">
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-success button-next">
