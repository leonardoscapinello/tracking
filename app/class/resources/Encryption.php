...
class Encryption
{
    ...
    public $ENC_KEY = "u5.DYS2QVw!-<G=ZKKu4r#OGqo*<z/85,OWgb#_e)qZpIUW+jxXJom[LC[p(_IW"; // ENCRYPTION KEY
    public $ENC_IV = "JNPrvvNiM2Tdf5CElnDRfEVcxjTD2rna"; // ENCRYPTION IV.

    public $ENC_SALT = "xS$"; // THE SALT FOR PASSWORD ENCRYPTION ONLY.

    // DECLARE  REQUIRED VARIABLES TO CLASS CONSTRUCTOR
    public function __construct($METHOD = NULL, $KEY = NULL, $IV = NULL, $SALT = NULL)
    {
        try {
