...
class BrowserDetection
{
    ...
    public function __toString()
    {
        ...
        $values = array();
        $values[] = array('label' => 'Session agent', 'value' => $this->getUserAgent());
     ...
     * open-source Chromium _project - it's like a Chrome browser within IE).
    ...
    /**
     * Detect the user env from the details in the user agent string.
     * @access protected
     */
