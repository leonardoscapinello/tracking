...
if (!not_empty(get_request("module_slug")) || ($modules->isDomainRequired() && !not_empty(get_request("domain")))) {
...
<div id="main" class="layout-column flex">
    ...
    <div id="header" class="page-header ">
        <div class="navbar navbar-expand-lg">
            <!-- brand -->
            <a href="<?= $url->application("dashboard")->page("dashboard")->output() ?>" class="navbar-brand d-lg-none">
